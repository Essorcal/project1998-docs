...
KOG = {
    ...
    "tree": [
        ...
        "\u2514\u2500 Army Quarters (4546)  \u2717 no terrain",
    ],
    "questions": [
        "Koguryo Tribunal Hall (4503) has terrain but wasn\u2019t reachable on the live walk (a locked courtyard door?) \u2014 where does it connect?",
