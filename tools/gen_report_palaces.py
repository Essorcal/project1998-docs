...
BUYA = {
    ...
    "maps": [
        (4604, "hub", "Courtyard \u2014 5 north vestibule doors to the room set below, plus the EAST door \u2192 Secret Garden (you arrive on the garden's west bridge)."),
        ...
        (4606, "wired", "Throne Room \u2014 behind the courtyard\u2019s center/grand door; its GREEN center section connects to Lasahn\u2019s Chambers (4611)."),
        ...
        (4613, "wired", "Secret Garden \u2014 reached from the Courtyard\u2019s EAST door (you appear on the west bridge). One-way in; the ONLY way out is a warp at the central gazebo, which returns you to the Courtyard."),
        (4611, "wired", "Lasahn\u2019s Chambers \u2014 connects to the Throne Room\u2019s green center section."),
    ...
    "tree": [
        ...
        "\u251c\u2500 Throne Room (4606) \u2713center \u2500\u2500 Lasahn's Chambers (4611)  via green center section",
        "\u251c\u2500 Royal Court (4609)            door order best-guess",
        "\u251c\u2500 Imperial Army (4615) \u2500\u2500 Training Hall (4610)  via army's top door",
        "\u2514\u2500 [EAST door] Secret Garden (4613)  in \u2192 west bridge; out ONLY via gazebo \u2192 courtyard",
    ],
    "questions": [
        ...
        "Where does Imperial Promenade (4612) connect? It has one exit with no geometric destination.",
...
KOG = {
    ...
    "questions": [
        ...
        "Stairway maps are a TRAP: many maps look identical in the live client (same tiles) but are DISTINCT maps, one set per palace, told apart only by their doors + guards. Koguryo’s own is Royal Palace Stairway 4514 (wired here to Throne + Baths per the live capture); the visually-identical Stairway 5823/5825/5827 belongs to the NAGNANG palace and is left untouched. When wiring, trust the enter-map id from a capture, not the picture.",
    ],
}
